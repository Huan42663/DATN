                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <div class="hstack gap-2 justify-content-end">
                                            ...
                                            <form action="{{route('Administration.sizes.destroy', $value)}}" method="post">
                                                @csrf
                                                @method('DELETE')
                                                <button class="avatar-text avatar-md" type="submit" onclick="return confirm('Bạn có muốn xóa size này không?')">
