                ...
                <div class="card border-top-0">
                    <div class="tab-content">
                        <div class="card-body personal-info">
                            ...
                            @endif
                            <form action="{{ route('Administration.posts.store') }}" method="POST"
                                ...
                                <div class="row mb-4 align-items-center">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="title" name="title"
                                                ...
                                                @if (isset($_SESSION['data']['title'])) value="{{ $_SESSION['data']['title'] }}"
                                                @else
                                                ...
                                                <select name="category_post_id" class="form-control" id="">
                                                    @foreach ($categoryPost as $value)
                                                        <option value="{{ $value->category_post_id }}"
                                                            @if (isset($_SESSION['data']['category_post_id']) && $_SESSION['data']['category_post_id'] == $value->category_post_id) @selected(true)
                                                        @elseif (old('category_post_id') == $value->category_post_id)
                                                            @selected(true) @endif>
                                    ...
                                    <div class="row mb-4 align-items-center">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="input-group">
                                                <textarea name="short_description" cols="10" rows="3" class="form-control">
@if (isset($_SESSION['data']['short_description']))
{{ $_SESSION['data']['short_description'] }}
@else
...
@endif
                                    ...
                                    <div class="row mb-4 align-items-center">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="">
                                                <textarea id="editor" name="content" rows="10" data-auto-grow="false">
@if (isset($_SESSION['data']['content']))
...
@endif
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <a href="{{ route('Administration.posts.list') }}"><button type="button"
                                                class="btn btn-sm btn-primary">Danh sách bài viết</button></a>
                                    </div>
                            </form>
                        </div>
                    </div>
