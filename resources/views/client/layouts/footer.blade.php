            ...
            <div class="content-footer py-[60px] flex justify-between flex-wrap gap-y-8">
                <div class="company-infor basis-1/4 max-lg:basis-full pr-7">
                    ...
                    <div class="flex gap-5 mt-3">
                        ...
                        <div class="flex flex-col w-1/3">
                            ...
                            <span class="text-button mt-3">Điện Thoại:</span>
                            <span class="text-button mt-3">Địa chỉ:</span>
                        </div>
                       
                        <div class="flex flex-col w-2/3">
                            <span class="">jstore@gmail.com</span>
                            <span class="mt-3">0981725836</span>
                            <span class="mt-3">Tòa nhà FPT Polytechnic., Cổng số 2, 13 P. Trịnh Văn Bô, Xuân Phương, Nam Từ Liêm, Hà Nội, Việt Nam</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="right-content flex flex-wrap gap-y-8 basis-3/4 max-lg:basis-full">
                    ...
                    <div class="newsletter basis-1/3 pl-7 max-md:basis-full max-md:pl-0">
                        ...
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1706.7721157814683!2d105.74611404603934!3d21.038029643877834!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x313455e940879933%3A0xcf10b34e9f1a03df!2zVHLGsOG7nW5nIENhbyDEkeG6s25nIEZQVCBQb2x5dGVjaG5pYw!5e1!3m2!1svi!2s!4v1734424205907!5m2!1svi!2s"
