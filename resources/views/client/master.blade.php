...
<head>
    ...
    <link rel="preload" href="{{ asset('Client/_next/static/media/8de40de8211748f7.p.woff2') }}" as="font"
    ...
    <link rel="preload" as="script" fetchPriority="low"
        href="{{ asset('Client/_next/static/chunks/webpack-8da1beb5d10bd904.js') }}" crossorigin="" />
    ...
    <script src="{{ asset('Client/_next/static/chunks/polyfills-c67a75d1b6f99dc8.js') }}" crossorigin="" noModule="">
    </script>
    <link rel="preconnect" href="https://fonts.gstatic.com">
    <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@300;400;700&display=swap" rel="stylesheet">
</head>

<body class="__className_082e4d" style="background-color:rgb(249,246,241) ; font-family:roboto;">
