...
<!-- Mirrored from wphtml.com/html/tf/duralux-demo/auth-404-creative.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 22 Sep 2024 14:55:57 GMT -->
                    ...
                    <div class="row flex-1 g-0">
                        <div class="col-lg-6 h-100 my-auto">
                            ...
                            <div class="creative-card-body card-body p-sm-5">
                                ...
                                <p class="fs-12 fw-medium text-muted">Sorry, the page you are looking for can't be
                                    found. Please check the URL or try to a different page on our site.</p>
                                <div class="mt-5">
                                    <a href="{{ back() }}" class="btn btn-light-brand w-100">Back Home</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 bg-primary">
                            <div class="h-100 d-flex align-items-center justify-content-center">
                                <img src="/admin/assets/images/auth/auth-user.png" alt="" class="img-fluid">
                            </div>
                        </div>
                    </div>
                </div>
